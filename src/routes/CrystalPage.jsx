...
const dummy = [
  {
    text:
      "봄이 왔는데도 추위가 계속되자 아픈 동물들이 많다고 해요~ " +
...
const CrystalPage = () => {
  ...
  const handleNext = () => {
    setCurrentIndex((prev) => (prev < dummy.length - 1 ? prev + 1 : prev));
  };
  ...
  return (
    <div className="bg-[#ead4fe] rounded-2xl flex">
      ...
      <div className="w-[550px] bg-white rounded-2xl mt-[33px] mr-5 mb-5">
        ...
        <img
          src={crystalHeader}
          className="ml-[10px] w-[530px] mt-2"
          alt="라즈벨의 수정구슬 헤더"
        />
        <div className="relative bg-gradient-to-b from-[#97a4ec] to-[#fbf6ff] mx-[10px] rounded-b-xl mb-5">
          <div className="pb-[0.1px]">
            ...
            <div className="bg-white mx-[10px] rounded-b-[5.5px] pt-3 px-5 mb-5 font-gulim text-[12px]">
              <div className="mt-[80px] text-[12px] items-center">
                {text}
                <img src={img} alt="동물농장 소식" />
              </div>
