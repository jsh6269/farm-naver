...
const HospitalWardPage = () => (
  ...
  >
    <div className="w-[555px] bg-white font-gulim text-[12px] rounded-lg overflow-hidden mb-5">
      ...
      <div className="mx-2.5 mb-3 bg-gradient-to-b from-[#ffffa3] to-[#E5F7FC] rounded-b-lg overflow-hidden pb-1">
        <div className="bg-white mx-[10px] mb-3 rounded-b-lg py-4 px-2 pb-6">
          <FestivalSearchBox
            ...
            {WARD_PETS.map((p) => (
              <div key={p.name} className="w-[126px] text-center">
                <button type="button" className="cursor-pointer">
                  <img src={p.img} alt={p.name} width={105} height={105} />
                </button>
