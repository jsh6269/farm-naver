...
const HospitalClinicPage = () => (
  ...
  >
    ...
    <div className="w-[555px] bg-white font-gulim text-[12px] rounded-lg overflow-hidden mb-5">
      ...
      <div className="mx-2.5 mb-4 bg-gradient-to-b from-[#fec764] to-[#E5F7FC] rounded-b-lg overflow-hidden pb-1">
        <div className="bg-white mx-[10px] mb-3 rounded-b-lg py-8 flex flex-col items-center">
