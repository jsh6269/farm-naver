...
const FoodShopCookPage = () => (
  ...
  >
    ...
    <div className="w-[555px] bg-white font-gulim text-[12px] rounded-lg overflow-hidden mb-5">
      ...
      <div className="mx-2.5 mb-3 bg-gradient-to-b from-[#d1955b] from-10% via-[#FEFBD9] via-70% to-[#FEFBD9] rounded-b-lg overflow-hidden pb-1">
        <div className="bg-white mx-[10px] mb-1 rounded-b-lg pt-4 pb-6">
